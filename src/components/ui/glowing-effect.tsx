...
function animateValue(
  ...
  const tick = (now: number) => {
    ...
    options.onUpdate(from + (to - from) * easedProgress);
          ...
          style={
            {
              ...
              '--gradient':
                ...
                radial-gradient(circle at 40% 40%, #f472b6 5%, #f472b600 15%),
                radial-gradient(circle at 60% 60%, #a855f7 10%, #a855f700 20%),
                radial-gradient(circle at 40% 60%, #8b5cf6 10%, #8b5cf600 20%),
                repeating-conic-gradient(
                  from 236.84deg at 50% 50%,
                  #ec4899 0%,
                  #f472b6 calc(25% / var(--repeating-conic-gradient-times)),
                  #a855f7 calc(50% / var(--repeating-conic-gradient-times)),
